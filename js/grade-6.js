...
const displayQuestion = (i) => {
    i = index;
    fetch('https://gk-quiz-api.herokuapp.com/grade6')
        .then(response => response.json())
        .then(data => {
            if (i <= data.length - 1) {
                scoreElement.textContent = `${score} / ${data.length}`; 
                if (data[i].id != 35 && data[i].id != 36 && data[i].id != 37 && data[i].id != 38 && data[i].id != 39 && data[i].id != 40 && data[i].id != 41 && data[i].id != 42 && data[i].id != 43 && data[i].id != 46 && data[i].id != 47 && data[i].id != 48 && data[i].id != 49 && data[i].id != 50 && data[i].id != 51 && data[i].id != 52 && data[i].id != 53 && data[i].id != 54 && data[i].id != 55) {
                    imageElement.remove();
