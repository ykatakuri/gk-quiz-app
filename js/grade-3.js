    ...
    fetch('https://gk-quiz-api.herokuapp.com/grade3')
        ...
        .then(data => {
            if (i <= data.length - 1) {
                ...
                if (data[i].id != 14 && data[i].id != 15 && data[i].id != 16 && data[i].id != 17 && data[i].id != 18 && data[i].id != 19 && data[i].id != 20 && data[i].id != 21 && data[i].id != 22 && data[i].id != 23 && data[i].id != 24 && data[i].id != 25) {
                    imageElement.remove();
