    ...
    fetch('https://gk-quiz-api.herokuapp.com/grade1')
        ...
        .then(data => {
            if (i <= data.length - 1) {
                ...
                if (data[i].id != 16 && data[i].id != 17 && data[i].id != 18 && data[i].id != 29 && data[i].id != 30 && data[i].id != 31 && data[i].id != 32 && data[i].id != 33 && data[i].id != 34 && data[i].id != 35 && data[i].id != 36 && data[i].id != 37) {
                    imageElement.remove();
